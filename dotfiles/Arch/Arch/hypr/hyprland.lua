...
--touchpad = { natural_scroll = false, disable_while_typing = true, scroll_factor = 1.0, tab_to_click = true, tap_and_drag = true, drag_lock = 1, clickfinger_behavior = false, middle_button_emulation = false, drag_3fg = 0, }, }, })
...
require("onf.decorations.default")
